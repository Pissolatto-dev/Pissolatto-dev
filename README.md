...
Sou um entusiasta de tecnologia focado em entender como os sistemas funcionam por dentro. Atualmente, estou no meu segundo ano de graduação, dedicando meus estudos a redes, segurança da informação e modelagem matemática aplicada à computação.

---

###  No que estou trabalhando:
-  Aprofundando conhecimentos em **Segurança Ofensiva e Defensiva**.
-  Desenvolvendo programas em **Java com Programação Orientada a Objetos**.
-  Aprendendo constantemente sobre **Estruturas de Dados**.
-  Explorando **Sistemas Embarcados e Robótica** com Arduino.
